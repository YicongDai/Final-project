...
<body>
	...
	<%
        ...
        double login_test = -1;   //boolean judge if login successfully
          try{   
             // connect mongodb 
            ...
            while (cursor.hasNext()) {     //search all
                ...
                if(toname.equals("test")&& topassword.equals("test")&&vcode.equals(login.getVcode())){
                	login_test=0;
                }
                else if(toname.equals(userName) && topassword.equals(passWord)&&vcode.equals(login.getVcode())){  
                    login_test = 2;
                    login.add(userName);
